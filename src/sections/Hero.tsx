...
export default function Hero() {
  ...
  >
    ...
    className='absolute h-[344px] w-[344px] md:h-[580px] md:w-[580px] rounded-full border opacity-20 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2'>
    ...
    className='absolute h-[544px] w-[544px] md:h-[980px] md:w-[980px] rounded-full border border-white opacity-30 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2'>
      <div className='absolute h-2 w-2 md:h-4 md:w-4 bg-white left-0 top-1/2 -translate-x-1/2 -translate-y-1/2 rounded-full'></div>
